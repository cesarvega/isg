...
import { CustomerContactBuilder } from '../services/builders/customer/customer-contact-builder';
import { IdentityFormInterface, AccountFormInterface, creditCheckInterface } from '../services/interfaces/customer/credit-check-form';
import { Store } from '@ngrx/store';
import { selectQuoteId, selectCustomer, selectSelectedAddress } from '../store/selectors';
import { ErrorInterface } from '../services/interfaces/common/error-interface';
import { setCustomerAction, setCustomerForms, setStepAction } from '../store/actions';
...
import { AddressInterface } from '../services/interfaces/customer/customer';
